...
public class GoldRush {
    ...
    // This question is asked by Amazon. Given a 2D matrix that
    // represents a gold mine, where each cell’s value represents an
    // amount of gold, return the maximum amount of gold you can collect
    ...
    // From the current cell, you may walk one cell to the left,
    // right, up, or down
    ...
    // Space complexity: O(N) where N is the total number of cells in our grid (this results from having N levels of functions calls on our stack due to our recursion).
